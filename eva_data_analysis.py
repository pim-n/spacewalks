...
def plot_cumulative_time_in_space(eva_data, graph_file):
    """
    Compute cumulative time in space and plots using matplotlib

    Args:
        eva_data (pd.DataFrame): dataframe object of our data
        graph_file (str): The file path of the output file
    """
